                ...
                <div class="row justify-between items-end pt-40">
                    <div class="col-auto">
                        <div class="row x-gap-20 y-gap-20 items-center">
                            <div class="col-auto">
                                <h1 class="text-26 fw-600">Warwick Allerton Hotel Chicago</h1>
                            </div>
                        ...
                        <div class="row x-gap-20 y-gap-20 items-center">
                            <div class="col-auto">
                                <div class="text-15 text-light-1">Moscow Road , Kensington and Chelsea, London, W2 4EL, United Kingdom</div>
                            </div>
            ...
            <div class="row y-gap-30">
                <div class="col-xl-auto">
                    <div class="ratio ratio-1:1 col-12 col-md-4 col-xl-12">
                        <img src="img/backgrounds/1.png" alt="image" class="img-ratio rounded-4">
                    </div>
